...
class cCACanvas {
  ...
  constructor(poOptions, poElement) {
    ...
    cCAEventHelper.subscribe_to_grid_events(this.grid_name, (poEvent) =>
      oThis._onCAGridEvent(poEvent),
    )
  }
  ...
  _onCAGridEvent(poEvent) {
    ...
    switch (poEvent.action) {
      ...
      case cCAGridEvent.notify.nochange:
        ...
        var oCanvasEvent = new cCACanvasEvent(
          this.grid_name,
          cCACanvasEvent.notify.nochange,
          null,
        )
  ...
  _get_cell_rc_from_event(poEvent, pbChangedOnly) {
    var oElement = this.element
    var X =
      poEvent.offsetX - cJquery.get_padding_width(oElement) + this.cell_size
    var Y =
      poEvent.offsetY - cJquery.get_padding_height(oElement) + this.cell_size
