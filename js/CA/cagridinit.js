...
class cCAGridInitialiser {
	init(poGrid, piInitType) {
		...
		switch (piInitType) {
			case cCAGridTypes.init.blank.id: break
			case cCAGridTypes.init.block.id: this.init_block(poGrid); break
			case cCAGridTypes.init.checker.id: this.init_checker(poGrid); break
			case cCAGridTypes.init.circle.id: this.init_circle(poGrid); break
			case cCAGridTypes.init.cross.id: this.init_cross(poGrid); break
			case cCAGridTypes.init.diagonal.id: this.init_diagonal(poGrid); break
			case cCAGridTypes.init.diamond.id: this.init_diamond(poGrid); break
			case cCAGridTypes.init.horiz_line.id: this.init_horiz_line(poGrid); break
			case cCAGridTypes.init.random.id: this.init_random(poGrid); break
			case cCAGridTypes.init.sine.id: this.init_sine(poGrid); break
			case cCAGridTypes.init.vert_line.id: this.init_vert_line(poGrid); break
			//--------------------------------------------------------
			default:
